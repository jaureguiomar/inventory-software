...
export const update_activity_log_access = async(connection:Connection, data:ActivityLogAccessMySQL) => {
...
export const delete_activity_log_access = async(connection:Connection, data:MySQLDelete) => {
