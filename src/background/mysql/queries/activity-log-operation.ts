...
export const insert_activity_log_operation_mysql = async(connection:Connection, data:ActivityLogOperationMySQL) => {
   const promise_insert_activity_log_operation = new Promise<number>((resolve) => {
      let query = "";
      query += "insert into activity_log_operation set ";
...
export const update_activity_log_operation_mysql = async(connection:Connection, data:ActivityLogOperationMySQL) => {
...
export const delete_activity_log_operation_mysql = async(connection:Connection, data:MySQLDelete) => {
