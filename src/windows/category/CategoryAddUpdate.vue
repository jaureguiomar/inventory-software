...
export default defineComponent({
   ...
   methods: {
      async onAddUpdate() {
         ...
         if(this.id <= 0) {
            let response:AxiosResponse = await Vue.prototype.$http.put("category/v3/create.php", {
            ...
            let response:AxiosResponse = await Vue.prototype.$http.post("category/v3/update.php", {
               id: this.id,
               name: this.data.name.text,
            });
            if(response) {
